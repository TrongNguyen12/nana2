      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{!! (Request::segment(2) === 'cate' || Request::segment(2) === 'product' || (isset($_GET['type']) && ($_GET['type'] == 'size'))) ? 'active' : '' !!} treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::segment(3) === 'brand' ? 'active' : null }}"><a href="{{ asset('backend/product/brand') }}"><i class="fa fa-circle-o"></i> Thương hiệu</a></li>
            <li class="{{ Request::segment(3) === 'config' ? 'active' : null }}"><a href="#"><i class="fa fa-circle-o"></i> Cài đặt</a></li>
          </ul>
        </li>
        ...
        <li class="{{ Request::segment(2) === 'order' ? 'active' : null }}">
          ...
          <li class="{{ Request::segment(2) === 'blog' ? 'active' : null }}" style="display: none;">
              <a href="#">
        ...
        <li class="{!! Request::segment(2) === 'config' ? 'active' : '' !!} treeview">
          ...
          <ul class="treeview-menu"> 
            ...
            <li class="{{ Request::segment(3) === 'policy' ? 'active' : null }}"><a href="{{ asset('backend/config/policy') }}"><i class="fa fa-circle-o"></i> Chính sách</a></li>
              ...
              <li class="{{ Request::segment(3) === 'bank' ? 'active' : null }}"><a href="{{ asset('backend/config/bank') }}"><i class="fa fa-circle-o"></i> Ngân hàng</a></li>

              <li class="{{ Request::segment(3) === 'partner' ? 'active' : null }}"><a href="#"><i class="fa fa-circle-o"></i> Đối tác</a></li>
              <li class="{{ Request::segment(3) === 'customer' ? 'active' : null }}"><a href="{{ asset('backend/config/customer') }}"><i class="fa fa-circle-o"></i>Nhận xét khách hàng</a></li>
              ...
              <li class="{{ Request::segment(3) === 'other' ? 'active' : null }}"><a href="{{ asset('backend/config/other') }}"><i class="fa fa-circle-o"></i> Khác</a></li>
          </ul>
        </li> 
