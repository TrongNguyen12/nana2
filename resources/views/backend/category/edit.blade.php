                        ...
                        <div class="col-lg-4">
                            @if(isset($data->image))
                                ...
                                <div class="form-group">
                                    <img src="{{ asset('uploads/category/'.$image->image) }}" alt="">
                                </div>
                            @endif
                            <div class="form-group">
                            ...
                            @if(isset($data->image))
                                @php
                                    $image = json_decode($data->image);
                                @endphp
                                @if (isset($image->imageHV))
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/category/'.$image->imageHV) }}" alt="">
                                    </div>
                                @endif
                            @endif
                            <div class="form-group">
                                <label>Hình ảnh di chuột ( Hover )</label>
                                <div class="file-loading">
                                    <input id="inpImg3" name="fImageHV" type="file">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Tiêu đề</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="parent_id" class="form-control">
                                    ...
                                    @php
                                        menuMulti( $parent  , 0 , '' , $data->parent_id);
                                    @endphp
                                </select>
