        ...
        <table id="example1" class="table table-bordered table-striped table-hover">
          ...
          ?>
              <tr>
                ...
                <td>{!! $i !!}</td>
                 <td>
                     <a class="text-default" href="{!! route('backend.product.getEdit',$item['id']) !!}" title="Sửa">
                         <img src="{{ asset('uploads/product/avatar') }}/{{ $item['image'] }}" class="img-responsive imglist" />
                     </a>
                 </td>
                <td>
                ...
                <td>
                    Giá bán: {!! number_format($item['price'],0,',','.') !!} đ 
                    @if ($item->price_promotion > 0 && $item->sale )
                      <br>
                      Giá sale: {!! number_format($item['price_promotion'],0,',','.') !!} đ 
                    @endif
                </td>
                <td>
