        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="true">Thông tin chung</a></li>
              ...
              <li class="" style="display: none;"><a href="#product_video" data-toggle="tab" aria-expanded="false">Video</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="price_promotion" min="0" value="{!! old('price_promotion',0) !!}" id="price_promotion">
                        </div>
                        <div class="form-group" id="dateEndSale">
                            ...
                            <input type="text" class="form-control" id="reservation" name="dateEndSale">
                          </div>
                        </div>
                        <div class="form-group">
                            <label>Tùy chọn màu sắc</label>
                              <input type="text" class="form-control " data-role="tagsinput" name="option">
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
